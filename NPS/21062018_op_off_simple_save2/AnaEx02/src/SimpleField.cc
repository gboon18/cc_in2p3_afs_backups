...
SimpleField::SimpleField()
{
  ...
  //  const char * filename_5cm ="../AnaEx02/DumpMagnet/SAM-Mc.table_5cm_step";//5cm grid field off 20180621
  const char * filename_20cm ="../AnaEx02/DumpMagnet/SAM-Mc.table_20cm_step";//20cm grid field off 20180621
  double lenUnit= cm;
  // G4cout << "\n-----------------------------------------------------------"
  ...
  //20180621(start)(5cm grid field off)
  ...
  //20180621(start)(20cm grid field off)
...
void SimpleField::GetFieldValue(const double point[4],double *Bfield) const
{
  ...
  */
  ...
  //end  MAP
  //20180621(finish)(20cm grid field off)
}
