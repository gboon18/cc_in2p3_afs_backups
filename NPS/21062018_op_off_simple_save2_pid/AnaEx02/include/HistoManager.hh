...
public:
  ...
  //20180621(start)
  void SetFluxCrystFrontCoverPerStep(G4int, G4int, G4double, G4ThreeVector);
  //20180621(finish)
...
private:
  ...
  //20180621(start)
  G4int    fCrystFrontCover_PID[MaxNtuple];
  G4double fCrystFrontCover_Edep[MaxNtuple];
  // G4ThreeVector fCrystFrontCover_Pos[MaxNtuple];
  G4double fCrystFrontCover_Pos_x[MaxNtuple];
  G4double fCrystFrontCover_Pos_y[MaxNtuple];
  G4double fCrystFrontCover_Pos_z[MaxNtuple];
  //20180621(finish)
