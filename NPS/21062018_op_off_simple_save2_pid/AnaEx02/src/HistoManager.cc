   ...
   //20180425(finish)
{
  ...
  //20180621(start)
  fCrystFrontCover_PID[MaxNtuple] = {0};
  fCrystFrontCover_Edep[MaxNtuple] = {0.};
  // fCrystFrontCover_Pos[MaxNtuple] = {G4ThreeVector(0.,0.,0.)};
  fCrystFrontCover_Pos_x[MaxNtuple] = {0.};
  fCrystFrontCover_Pos_y[MaxNtuple] = {0.};
  fCrystFrontCover_Pos_z[MaxNtuple] = {0.};
  //20180621(finish)
}
...
{ 
  ...
  //20180621(start)
fNtuple2 = new TTree("t2","Checking the flux at the front face of the NPS, Cryst Front Cover");
  fNtuple2->Branch("pid", fCrystFrontCover_PID, "PID[1116]/I");
  fNtuple2->Branch("edep", fCrystFrontCover_Edep, "energy_deposition[1116]/D");
  // fNtuple2->Branch("pos", fCrystFrontCover_Pos, "Position[1116]/D");
  fNtuple2->Branch("x", fCrystFrontCover_Pos_x, "x_Position[1116]/D");
  fNtuple2->Branch("y", fCrystFrontCover_Pos_y, "y_Position[1116]/D");
  fNtuple2->Branch("z", fCrystFrontCover_Pos_z, "z_Position[1116]/D");
  //20180621(finish)
...
{
  if(edep) fEdep[id] = edep;//if(fEdep[id])G4cout<<"Getting fEdep[id] : "<<fEdep[id]<<"["<<id<<"]"<<G4endl;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void HistoManager::SetFluxCrystFrontCoverPerStep(G4int id, G4int PID, G4double edep, G4ThreeVector pos)
{

  if(edep>0)G4cout<<edep<<G4endl;

  fCrystFrontCover_PID[id] = PID;
  fCrystFrontCover_Edep[id] = edep;
  // fCrystFrontCover_Pos[id] = pos;
  fCrystFrontCover_Pos_x[id] = pos.x();
  fCrystFrontCover_Pos_y[id] = pos.y();
  fCrystFrontCover_Pos_z[id] = pos.z();
}
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
