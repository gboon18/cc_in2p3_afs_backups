{
  ...
  //     h_elec_pattern_on->Fill(angle, y, elec1[j]);
  //     h_elec_ene_on->Fill(angle, elec1[j]*MeV_to_rad_per_hr);
  //     h_gamma_pattern_on->Fill(angle, y, gamma1[j]); 
  //     h_gamma_ene_on->Fill(angle, gamma1[j]*MeV_to_rad_per_hr);
  //     h_pos_pattern_on->Fill(angle, y, pos1[j]);
  //     h_pos_ene_on->Fill(angle, pos1[j]*MeV_to_rad_per_hr);
