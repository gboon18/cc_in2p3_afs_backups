void pattern(/* int i = 0 */){
  ...
  string file_dir = "/sps/clas/hosanko/NPS/geant4.10.03.p01_wMT/magnetic/27022018_2by2/rootfiles/27022018_2by2_resolution_";
  string file_end = "_0000%d.root";

  string output_string_front = "/sps/clas/hosanko/NPS/geant4.10.03.p01_wMT/draw/resolution/output/27022018_2by2/energy/edep/pattern/edep";
  ...
  for(int gap_size = 1 ; gap_size < 5 ; gap_size++){
...
/* } */
  ...
  c_edep->cd(4);
  h->Draw();
  //  c_edep->Print("/sps/clas/hosanko/NPS/geant4.10.03.p01_wMT/draw/resolution/output/27022018_2by2/energy/edep/shape.eps");
  c_edep->Print(output_char);
  c_edep->Close();
