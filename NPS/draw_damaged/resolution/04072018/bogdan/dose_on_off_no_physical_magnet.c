{
  ...
  string dir_str = "/sps/clas/hosanko/NPS/geant4.10.03.p01_wMT/magnetic/04072018/rootfiles_bogdan/";
  ...
  int x, y;
  int No_event = 1e7;//each file has 1e5 events. 100 files per settings
  double angle;
  ...
  TH2F *h_edep_pattern_off = new TH2F("h_edep_pattern_off", "edep pattern, field off", 41, 1, 42, 36, 0, 36);//(x, y)
