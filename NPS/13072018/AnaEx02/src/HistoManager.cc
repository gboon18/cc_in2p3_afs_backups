...
{ 
  ...
  //20180713(start) reuse for Pseudo Sphere   
  //20171127(start)
  fNtuple3 = new TTree("t3","Checking the flux at the front face of the NPS");
  fNtuple3->Branch("fluxEnergy", &fFluxEnergy, "Energy of the flux in psuedo volume/D");
  fNtuple3->Branch("fluxPID2", &fFluxPID2, "PID of the flux in psuedo volume/I");
  fNtuple3->Branch("x", &fPos_x, "Position(x) of the flux in psuedo volume/D");
  fNtuple3->Branch("y", &fPos_y, "Position(y) of the flux in psuedo volume/D");
  fNtuple3->Branch("z", &fPos_z, "Position(z) of the flux in psuedo volume/D");
  //20180713(finish)
  /*
  //20171127(finish)
  //20171129(start)
