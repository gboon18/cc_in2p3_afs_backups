...
#include "B5MagneticField.hh"//for magnetic field(just in case)
//20171009(finish)
...
//20171009(start)
G4ThreadLocal B5MagneticField* DetectorConstruction::fMagneticField = 0;
  ...
  fDetectorMessenger(0)
{
  ...
  //20171128(finish)
  //20171124(finish)
  fTargetLength      = (129.759 - 29.759)*mm; 
  fTargetRadius      = 20.179*mm;
  fTargetCoverLength = (129.887 - 29.759)*mm; 
...
G4VPhysicalVolume* DetectorConstruction::ConstructVolumes()
{
  ...
  //20180209(start)
  fMom_pos_Z = 4000*mm + 0.5*fSingle_Z;//the position of front face wrapper of the crystal is 4m away from the center of the world.
  //20180209(finish)
  ...
  //20171123(finish)
  new G4PVPlacement(0,//xTargetRot,//20171123
		    G4ThreeVector(0.*mm, 0.*mm, 0.5*fTargetCoverLength),//G4ThreeVector(0.*mm, -0.5*fTargetCoverLength, 0.*mm),//20171123//
		    fLogicTargetCover,            //its logical volume
		    "TargetCover_pos",               //its name
		    lWorld,//fLogicInnerChamber,//20171123 put it inside the scattering chamber//lWorld,                     //its mother  volume
		    false,                 //no boolean operation
		    0,                     //copy number
		    fCheckOverlaps);       // checking overlaps 
  ...
  new G4PVPlacement(0,//xTargetRot,//20171123
		    G4ThreeVector(0.*mm, 0.*mm, fTargetCoverLength),//G4ThreeVector(0.*mm, -fTargetCoverLength, 0.*mm ),//20171123//G4ThreeVector(0.*mm, 0.*mm, fTargetCoverLength),
  ...
  new G4PVPlacement(0,                     //no rotation
		    G4ThreeVector(0.*mm, 0.*mm, 0.5*fTargetWindowThickness),//G4ThreeVector(0.*mm, -0.5*fTargetWindowThickness, 0.*mm),//20171123//G4ThreeVector(0.*mm, 0.*mm, 0.5*fTargetWindowThickness),
  ...
  fLogicChamberWindow = new G4LogicalVolume(sWindow_sub_InnerJoint2_sub_OuterJoint2,
  					    fWindowMater,
  					    "Window_log");
  //
  ...
  G4Sphere*
    sFlux = new G4Sphere("Flux_sol",
			 4000.*mm,//radius_min//NPS distance from the target
			 4000.*mm + fWrapThickness ,//radius_max
			 0.,//starting Phi angle
			 twopi,//ending Phi angle
			 0.,//starting Theta angle
  ...
  G4LogicalVolume* fLogicFlux = new G4LogicalVolume(sFlux,
						    fWorldMater,//air
						    "Flux_log");
  ...
  */
  ...
  // 		    G4ThreeVector(fSweepingMagnetSTPcenter_X - fSweepingMagnetSTPshift_X, fSweepingMagnetSTPcenter_Y - fSweepingMagnetSTPshift_Y, fSweepingMagnetSTPcenter_Z - fSweepingMagnetSTPshift_Z),
  // 		    //20180412(finish)
  // 		    fLogicMagnetic,
...
void DetectorConstruction::ConstructSDandField()
{
  ...
  //20180425(start)
  //delete
  //20180713(start) using it for Pseudo Sphere
